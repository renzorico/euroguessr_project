...
# bucket_name = "world_photos"
# model_path = "Model/3000_resnet50_opt5.keras"  # Change this to the path of your model file in GCS
# storage_client = storage.Client()
# bucket = storage_client.bucket(bucket_name)
...
#     blob.download_to_filename("3000_resnet50_opt5.keras")

#     # Load the CNN model using TensorFlow (you can modify this based on your CNN framework)
#     model = tf.keras.models.load_model("3000_resnet50_opt5.keras")
